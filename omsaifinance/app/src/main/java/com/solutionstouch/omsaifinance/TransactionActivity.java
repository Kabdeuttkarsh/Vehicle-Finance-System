...
import com.solutionstouch.omsaifinance.adapter.TransactionsAdapter;
...
public class TransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.rv_loan_detail);
    ...
    //setSupportActionBar(mToolbar);
        ...
        if (TextUtils.isEmpty(user_id) && TextUtils.isEmpty(loan_id)){
            ...
            getAllTransactions(loan_id,user_id);
        }

        }

        public void getAllTransactions(String loan_id, String user_id){
                ...
                public void onResponse(Call<TransactionResult> call, Response<TransactionResult> response) {
                    if (response.isSuccessful()){
                       ...
                       // mRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        transactionsAdapter = new TransactionsAdapter(getApplicationContext(),transactions);
                        LinearLayoutManager manager = new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.VERTICAL,false);
                        mRecyclerView.setLayoutManager(manager);
                        mRecyclerView.setAdapter(transactionsAdapter);
